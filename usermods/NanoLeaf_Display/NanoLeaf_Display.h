...
class NanoLeafDisplay : public Usermod {
  private:
    ...
    Segment *segments[NUM_OF_SEGMENTS];
  ...
  public:
     ...
     */
    void segCopyProps(Segment& seg1, Segment& seg2, int seg1Id) {
      seg1.setColor(0, seg1Id + NUM_FIRST_LEDS);
     ...
     */
    void turnOffSeg(Segment& seg, int segId) {
      seg.setColor(0, segId + NUM_FIRST_LEDS);
      seg.setColor(1, segId + NUM_FIRST_LEDS);
      seg.setColor(2, segId + NUM_FIRST_LEDS);
      seg.setOption(0, 0);
    }
